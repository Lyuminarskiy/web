...
Для позиционирования элементов сайта использовать `CSS Grid Layout` и `Flexible Box Layout`. Блоки объявления CSS отделить от HTML-документов и вынести в отдельные файлы. Эти файлы поместить в папку `styles`. Общие для всех страниц веб-сайта стили вынести в отдельный файл `style.css`.
