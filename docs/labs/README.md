...
3. `Задание` - информацию брать со страницы лабораторной работы:
    ...
    1. Общая информация.
    2. Задачи.
    3. Изображение макета со ссылками на страницу макета, демонстрацию и 
    исходный код.
    4. Прочие разделы, указанные на странице лабораторной работы.
...
5. `Веб-сайт` - полноразмерные снимки экранов всех страниц веб-сайта в двух
видах: для мобильных устройств и компьютеров.

Отчёт оформляйте на страницах формата `A4` с полями в `2 см`. Для содержимого
отчёта используйте шрифт `Times New Roman` размером `14 пт` и полуторный 
межстрочный интервал. При указании содержимого текстовых файлов используйте
моноширинный шрифт `Courier New` размером `10 пт` и одинарный межстрочный
интервал. Страницы отчёта пронумеруйте, номер страницы указывайте снизу 
страницы по центру.
...
::: tip На заметку
[Google Docs](https://www.google.ru/intl/ru/docs/about) умеет
[формировать оглавление](https://support.google.com/docs/answer/116338)
на основе заголовков и подзаголовков, используемых в документе.
:::
