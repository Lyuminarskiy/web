...
В каждой лабораторной работе вы необходимо будет выбрать макет, на основе 
которого вы бедете разрабатывать веб-сайт. Число макетов ограничено, поэтому
вводится ограничение на максимально возможное количество человек, выбравших 
один макет. Расчёт ограничения проводится по следующей формуле:
