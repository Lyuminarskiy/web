...
Частm этих сообщений можно избежать, если регулярно форматировать файл
через контекстное меню `Форматировать документ` или комбинации клавиш
`Shift+Alt+F`.
...
1. Проверяйте код в валидаторах [HTML](https://validator.w3.org)
...
3. Используйте **семантические элементы** в тех местах,
где они подходят по смыслу.

4. **Указывайте кодировку** у всех файлов HTML и CSS.

5. Указывайте заголовок, иконку, имя автора, описание и список ключевых слов
у всех страниц веб-сайта.

6. При использовании Node.js указывайте описание, лицензию, информацию об
...
выбравших один макет. Расчёт ограничения проводится по следующей формуле:
