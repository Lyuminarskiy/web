...
- Создайте новый атрибут и измените существующий атрибут у любого элемента на 
странице.
- Измените существующий атрибут любого элемента на странице.
- Включите имитацию наведения указателя мыши на элемент
(псевдокласс [`:hover`](https://webref.ru/css/hover)).
...
- Включите отображение медиа-запросов. Продемонстрируйте работу вашего 
медиа-запроса на разных эмулированных устройствах.
- Сделайте снимок экрана для всей страницы, включая области,
скрытые полосой прокрутки.
