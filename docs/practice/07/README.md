...
5. Продемонстрируйте преподавателю изменение дерева элементов и правил CSS 
документа с помощью инструментов разработчика Chrome:

    - Создайте новый атрибут и измените существующий атрибут любого элемента.
    - Создайте новое правило CSS у любого элемента и обозначьте в нём несколько 
    свойств CSS.
...
4. Продемонстрируйте преподавателю работу вашего медиа-запроса с помощью 
...
значений свойств при анимации.

4. При наведении указателя мыши на круг он должен останавливаться, плавно 
уменьшаться в диаметре и становиться полностью непрозрачным.

5. При появлении указателя мыши в пределах видимой области цвет фона должен 
плавно меняться с белого на чёрный.

6. Создайте собственную функцию для вычисления промежуточных значений 
свойств при анимации для любого круга.

7. Продемонстрируйте преподавателю запись и воспроизведение с анимаций с 
