...
Во всех обработчиках мы записывается в консоль текущие дату и время,`.
Эту избыточность можно устранить с использованием функций промежуточной 
обработки:
