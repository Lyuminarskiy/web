...
Создайте документ со следующим содержимым:
...
Укажите кодировку и установите заголовок документа. Убедитесь, что на вкладке браузера отображается ваш заголовок.

## 1.2. Использование базовых элементов HTML

Используя элементы заголовков и элемент блока текста, оформите рассказ А. И. Куприна *"Чудесный доктор"* в виде веб-страницы.

Отделите название рассказа от остального текста и части рассказа друг от друга горизонтальными линиями. Добавьте имя автора как всплывающую подсказку для названия рассказа. Не забудьте указать кодировку и заголовок документа.

<details>
<summary>Открыть текст рассказа</summary>
<hr>
...
Доработайте веб-страницу, созданную в предыдущем задании, выделив цветом все реплики персонажей. Можете менять как цвет текста реплики, так и его фон. Указывайте цвета как по названию, так и по из шестнадцатеричному коду.
