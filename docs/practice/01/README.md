# 1. Базовые элементы HTML. Универсальные атрибуты. Свойства CSS
...
<details>
<summary>А. И. Куприн, "Чудесный доктор", 1897 г. (нажмите, чтобы раскрыть)</summary>
...
Всегда указывайте **кодировку и заголовок документа**.
:::
