...
1. Поместите в элемент заголовка страницы элемент панели навигации.
2. Добавьте на панель навигации несколько ссылок и оформите их так, как 
показано в примере.
3. Поместите в элемент основного содержимого документа элемент блока информации.
4. Заполните блок информации элементами - независимыми фрагментами 
веб-страницы, содержащими внутри себя заголовок, и оформите их так, как 
показано в примере. Ширина элементов - `80%`, отступ снизу контейнера, размер
строк сетки.
5. Используйте преимущественно
