...
1. Назовите области следующими именами:
...
2. Размеры столбцов должны находиться в соотношении `1:3:1`.
3. Установите у строк одинаковую высоту.
4. Добавьте промежуток между ячейками.
5. В качестве цветов областей используйте следующие значения:
...
6. Установите уровень непрозрачности `60%` у элемента, расположенного в области `side2`.
7. Используйте подходящие семантические элементы.
8. Используйте только [селекторы класса](https://webref.ru/css/selector/class).
