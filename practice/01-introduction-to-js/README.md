...
7. [Операторы циклов](#Операторы-циклов)
    - [Последнее значение цикла](#Последнее-значение-цикла)
    - [Вывод чётных чисел](#Вывод-чётных-чисел)
    - [Замена оператора цикла](#Замена-оператора-цикла)
    - [Правильный ввод](#Правильный-ввод)
